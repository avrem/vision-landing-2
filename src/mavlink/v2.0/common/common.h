...
#define MAVLINK_COMMON_XML_HASH 2742245142593654239
...
typedef enum MAV_DO_REPOSITION_FLAGS
{
   ...
   MAV_DO_REPOSITION_FLAGS_VTOL_FORCE_FW=2, /* The VTOL aircraft should remain in fixed-wing loiter after reaching target | */
   MAV_DO_REPOSITION_FLAGS_VTOL_FORCE_MC=4, /* The VTOL aircraft should remain in multicopter loiter after reaching targets | */
   MAV_DO_REPOSITION_FLAGS_ENUM_END=5, /*  | */
...
#include "./mavlink_msg_gen_status.h"
